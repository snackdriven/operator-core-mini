...
Kayla. QA at Tebra/NHHA. Based in Bentonville, AR. AUDHD/PDA-aware
support style. Married, post-wedding April 2026. Prefers ambient,
low-demand surfaces.

## Defaults, workflows, and policies (Doctrine: pinned)
...
## Reference shelf (Backpack: pinned)

- **jira-old-key-quirk** — TTOAD is the post-migration board key. Old keys (SQDTOAD, etc.) are
