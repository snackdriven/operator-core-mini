...
├── hoard/
│   ├── YYYY/MM/DD/<id>.md       # YAML frontmatter validates against backpack-item.schema.json
│   │                            #   (hoard items share the backpack item shape; the optional
│   │                            #    `aged_out_at` field flips them into the aged-out window)
│   ├── blobs/                   # binary attachments referenced by hoard items
│   └── _hoard.jsonl             # generated by tools/bp_build.py; one JSON object per line
│                                #   (parsed frontmatter from each hoard/**/*.md)
└── policy/
